...
- **Hear it:** where the phone has a Japanese voice installed — iPhones do — a **Hear it** button reads the Japanese aloud at a slightly slowed pace. It uses the phone's own speech, so nothing is sent anywhere and it works offline. On a device with no Japanese voice the button is simply not shown rather than reading the Japanese in an English accent.
