...
export const PHRASEBOOK=[
 {id:'greetings',title:'Greetings and manners',note:'The ones worth knowing before you land.',phrases:[
  {id:'morning',en:'Good morning',ja:'おはようございます',romaji:'ohayō gozaimasu',say:'oh-ha-yoh go-zye-mass',hold:'yoh',note:'Until about ten or eleven in the morning. With each other you can drop the polite ending “go-zye-mass” and just say “oh-ha-yoh” — it is the difference between “morning” and “good morning”.',icon:'🌅'},
  ...
  {id:'evening',en:'Good evening',ja:'こんばんは',romaji:'konbanwa',say:'kon-ban-wa',note:'Once it is dark. There is no version of this for leaving — “oh-ya-soo-mee na-sigh” (good night) is only for going to bed.',icon:'🌙'},
  {id:'thanks',en:'Thank you',ja:'ありがとうございます',romaji:'arigatō gozaimasu',say:'a-ree-ga-toh go-zye-mass',hold:'toh',note:'Put “doh-mo” (very much) in front to warm it up. The past tense — “a-ree-ga-toh go-zye-mash-ta” (thank you for what you did) — is for something already finished, which is what you say on the way out of a restaurant.',icon:'🙏'},
  ...
  {id:'sorry',en:'I am sorry',ja:'ごめんなさい',romaji:'gomen nasai',say:'go-men na-sigh',note:'A real apology, for something you did. “Soo-mee-ma-sen” (excuse me) is the everyday one; this is the one for knocking something over.',icon:'😔'},
  {id:'please',en:'Please',ja:'お願いします',romaji:'onegai shimasu',say:'oh-neh-guy shee-mass',note:'The “please” for asking someone to do something. When you are pointing at a thing you want instead, “koo-da-sigh” (please give me) is the one.',icon:'🤲'},
  ...
  {id:'no',en:'No',ja:'いいえ',romaji:'iie',say:'ee-eh',note:'Rarely said straight out. “Dye-joh-boo dess” (I am fine), or just a trailing “chot-to…” (it is a bit…), does the job more gently — and is what you will hear back.',icon:'❌'},
  ...
  {id:'bye',en:'Goodbye',ja:'さようなら',romaji:'sayōnara',say:'sa-yoh-na-ra',hold:'yoh',note:'More final than it looks — nearer “farewell” than “bye”. Leaving a shop or a restaurant, “a-ree-ga-toh go-zye-mash-ta” (thank you for everything) does the job better.',icon:'👋'},
 ...
 {id:'basics',title:'When you are stuck',note:'For the moment the conversation runs ahead of you.',phrases:[
  {id:'english',en:'Do you speak English?',ja:'英語を話せますか？',romaji:'eigo o hanasemasu ka?',say:'ay-go oh ha-na-seh-mass ka',note:'Ask it after “soo-mee-ma-sen” (excuse me), not instead of it. Plenty of people will say “a little” and then manage far more than that.',icon:'🇬🇧'},
  ...
  {id:'whatisthis',en:'What is this?',ja:'これは何ですか？',romaji:'kore wa nan desu ka?',say:'ko-reh wa nan dess ka',note:'For a dish, a sign, a machine. Point as you say it — “ko-reh” means “this one, here”.',icon:'❓'},
 ...
 {id:'around',title:'Finding our way',note:'Point at the app, then say the phrase.',phrases:[
  ...
  {id:'walk',en:'Can I walk there?',ja:'歩いて行けますか？',romaji:'aruite ikemasu ka?',say:'a-roo-ee-teh ee-keh-mass ka',note:'The answer is usually yes. Follow it with “nan-poon dess ka” — how many minutes?',icon:'🚶'},
 ...
 {id:'shops',title:'Shops and paying',note:'Cash is still king in the small places. Ask before you order.',phrases:[
  ...
  {id:'justlooking',en:'Just looking, thank you',ja:'見ているだけです',romaji:'mite iru dake desu',say:'mee-teh ee-roo da-keh dess',note:'Staff greet you with “ee-rash-shy-mah-seh” (welcome) the moment you walk in and you are not expected to answer. This is for when somebody comes over.',icon:'👀'},
  ...
  {id:'bag',en:'A bag, please',ja:'袋をください',romaji:'fukuro o kudasai',say:'foo-koo-ro oh koo-da-sigh',note:'Bags are no longer free — expect a few yen, and a question at the till you can answer with “hye” (yes).',icon:'🛍️'},
 ...
 {id:'trouble',title:'If something goes wrong',note:'Worth having found once before you need it.',phrases:[
  {id:'help',en:'Please help me',ja:'助けてください',romaji:'tasukete kudasai',say:'ta-soo-keh-teh koo-da-sigh',note:'For real trouble. For “I am stuck, can you give me a hand”, “soo-mee-ma-sen” (excuse me) and pointing is the right size.',icon:'🆘'},
  {id:'hospital',en:'Where is a hospital?',ja:'病院はどこですか？',romaji:'byōin wa doko desu ka?',say:'byoh-een wa do-ko dess ka',hold:'byoh',note:'For anything that is not an emergency, a pharmacy — “yak-kyo-koo” — is often the faster first stop.',icon:'🏥'},
  ...
  {id:'police',en:'Please call the police',ja:'警察を呼んでください',romaji:'keisatsu o yonde kudasai',say:'kay-sat-soo oh yon-deh koo-da-sigh',note:'A kōban (“koh-ban”) is the small police box on the street corner, and is where lost property and lost people both end up.',icon:'👮'},
