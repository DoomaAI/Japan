...
export const PHRASEBOOK=[
 {id:'greetings',title:'Greetings and manners',note:'The ones worth knowing before you land.',phrases:[
  {id:'morning',en:'Good morning',ja:'おはようございます',romaji:'ohayō gozaimasu',say:'oh-ha-yoh go-zye-mass',hold:'yoh'},
  ...
  {id:'thanks',en:'Thank you',ja:'ありがとうございます',romaji:'arigatō gozaimasu',say:'a-ree-ga-toh go-zye-mass',hold:'toh'},
  ...
  {id:'fine',en:'It is fine / no thank you',ja:'大丈夫です',romaji:'daijōbu desu',say:'dye-joh-boo dess',hold:'joh',note:'Does the work of "I am OK", "no thanks" and "no problem".'},
  {id:'nicetomeet',en:'Nice to meet you',ja:'よろしくお願いします',romaji:'yoroshiku onegai shimasu',say:'yo-ro-shee-koo oh-neh-guy shee-mass'},
  {id:'bye',en:'Goodbye',ja:'さようなら',romaji:'sayōnara',say:'sa-yoh-na-ra',hold:'yoh'},
  {id:'itadakimasu',en:'Said before eating',ja:'いただきます',romaji:'itadakimasu',say:'ee-ta-da-kee-mass'},
  {id:'gochisou',en:'Said after eating — thank you for the meal',ja:'ごちそうさまでした',romaji:'gochisōsama deshita',say:'go-chee-soh-sa-ma desh-ta',hold:'soh'}]},
 {id:'basics',title:'When you are stuck',note:'For the moment the conversation runs ahead of you.',phrases:[
  ...
  {id:'again',en:'Once more, please',ja:'もう一度お願いします',romaji:'mō ichido onegai shimasu',say:'moh ee-chee-do oh-neh-guy shee-mass',hold:'moh'},
  {id:'slowly',en:'Please speak slowly',ja:'ゆっくり話してください',romaji:'yukkuri hanashite kudasai',say:'yook-koo-ree ha-na-shee-teh koo-da-sigh',hold:'yook'},
 ...
 {id:'trains',title:'Trains and getting about',note:'',phrases:[
  {id:'ticket',en:'Where do I buy a ticket?',ja:'切符はどこで買えますか？',romaji:'kippu wa doko de kaemasu ka?',say:'keep-poo wa do-ko deh ka-eh-mass ka',hold:'keep'},
  ...
  {id:'iccard',en:'Can I use an IC card?',ja:'ICカードを使えますか？',romaji:'IC kādo o tsukaemasu ka?',say:'eye-see kah-do oh tsoo-ka-eh-mass ka',hold:'kah'},
 ...
 {id:'shops',title:'Shops and paying',note:'',phrases:[
  ...
  {id:'card',en:'Can I pay by card?',ja:'カードで払えますか？',romaji:'kādo de haraemasu ka?',say:'kah-do deh ha-ra-eh-mass ka',hold:'kah'},
 ...
 {id:'children',title:'With the boys',note:'',phrases:[
  ...
  {id:'childfree',en:'Are children free?',ja:'子供は無料ですか？',romaji:'kodomo wa muryō desu ka?',say:'ko-do-mo wa moo-ryoh dess ka',hold:'ryoh'},
 ...
 {id:'trouble',title:'If something goes wrong',note:'Worth having found once before you need it.',phrases:[
  ...
  {id:'hospital',en:'Where is a hospital?',ja:'病院はどこですか？',romaji:'byōin wa doko desu ka?',say:'byoh-een wa do-ko dess ka',hold:'byoh'},
  ...
  {id:'allergy',en:'I have an allergy',ja:'アレルギーがあります',romaji:'arerugī ga arimasu',say:'a-reh-roo-gee ga a-ree-mass',hold:'gee'},
