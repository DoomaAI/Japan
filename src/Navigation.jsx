...
import {House,CalendarDays,Ticket,UtensilsCrossed,Coins,Trophy,NotebookPen,MapPin,Users,LifeBuoy,Inbox,FerrisWheel,ShoppingBag,BookOpen,Bell,Search,Heart,MoreHorizontal,ChevronRight} from 'lucide-react';
...
const ICONS={today:House,days:CalendarDays,tickets:Ticket,food:UtensilsCrossed,money:Coins,challenges:Trophy,
 ...
 shopping:ShoppingBag,guide:BookOpen,updates:Bell,search:Search,thanks:Heart};
