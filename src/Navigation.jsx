...
import {Camera,Dices,MessageSquare,House,CalendarDays,Ticket,UtensilsCrossed,Coins,PiggyBank,Trophy,NotebookPen,MapPin,Users,LifeBuoy,Inbox,FerrisWheel,ShoppingBag,BookOpen,Bell,Search,Heart,MoreHorizontal,ChevronRight} from 'lucide-react';
...
const ICONS={today:House,days:CalendarDays,tickets:Ticket,food:UtensilsCrossed,money:Coins,challenges:Trophy,games:Dices,photos:Camera,
 ...
 shopping:ShoppingBag,spending:PiggyBank,phrases:MessageSquare,guide:BookOpen,updates:Bell,search:Search,thanks:Heart};
