...
function App(){
 ...
 return <PhraseAudio.Provider value={{clips:visibleState?.phraseAudio||{},user,request,accept,notice,config,busy}}>
  ...
  {tab==='today'&&<>
   ...
   <NextUp state={visibleState} day={day} person={lens||null} now={now} selectStep={selectStep} open={setModal} go={go} parent={parent}/>
  ...
  {tab==='days'&&<><p className="eyebrow">21 SEPTEMBER — 6 OCTOBER</p><h1>Our days in Japan</h1><Button icon={ImageIcon} onClick={()=>setModal({type:'media'})}>Family photo & video gallery</Button>{/* The cover is the first page of the book rather than a picture of it: swipe and the guide
