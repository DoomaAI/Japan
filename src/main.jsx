...
import {primaryNav,moreIds,PAGES,cleanNav,emptyNav} from './nav-data.js';
...
function Tickets({state,user,step,initialSearch='',initialArchived=false,config,busy,setBusy,accept,mutate,notice,saved,saveOffline,selectStep}){
 ...
 const clearForm=()=>{setEditing(null);setFile(null);setFailedUpload(null);setProgress(0);setAllocated(step?[step.id]:[]);setReset(n=>n+1);};
