// Every text these notes have had on the live trip before the current one. A stop still
// holding one of them gets the current text; a stop the family has edited keeps its own.
export const NOTES_BEFORE={
 "2026-09-27-03": [
  "Travel: about 45 min on an Express (急行) to Kintetsu-Nara; about 35 min on a Limited Express (特急), which needs an extra reserved-seat ticket.\nFare: adult ¥760 · child ¥380 each (Kintetsu, Kyoto → Kintetsu-Nara).\nCheck current Kintetsu service."
 ],
 "2026-09-27-04": [
 ...
 "2026-10-05-01": [
  "Guide target; check opening time before leaving."
 ],
 "2026-10-06-03": [
