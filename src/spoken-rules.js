...
export const GAME_RULES={
 ...
 hanafuda: 'Hanafuda, which means flower cards. There are forty eight cards and twelve months, with four cards for each month. The only thing that matters for matching is the month. Pick a card from your hand, and if there is a card of the same month on the table you take them both. Then one card is turned over from the deck and does the same thing. Collect the right sets of cards and you score. When you score, you choose: stop and keep the points, or say koi koi and carry on for more, which doubles what the round is worth but could leave you with nothing.',
...
export const PAGE_RULES={
 today:'Home. This is what we are doing right now, and what is next. Swipe sideways to see the rest of the day. When we have finished something, press done.',
 days:'Itinerary. Every day of the whole trip, in order. Tap a day to see everything we are doing on it.',
 glance:'Today. This is everything we are doing today, in the order we are doing it. When we have finished one, tick the box beside it, and it steps back out of the way so you can see what is left. Tap the name of a stop to open it and find out more about it.',
 ...
 shortlist:'Purchase shortlist. This is for when you see something in a shop and you are not sure about it. Take a photo of it here, and say which shop it was in and how much it cost. Give it stars for how much you want it, out of five. You can also say where we were when we saw it. Then it turns up again on that day. Or press the pin button, and your phone remembers the exact spot, so we can walk back to it. Then later on we all look at the photos together and pick which ones we are actually getting.',
