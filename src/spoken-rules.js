...
export const GAME_RULES={
 ...
 sights:'Japan pairs. These are sake barrels, like the ones stacked up outside a shrine, and every one has a twin. Tap one and it spins round to show you the picture. Spin two. If they are the same they stay turned, and if they are not, they spin back. Try to remember where things were, and find all the pairs.',
