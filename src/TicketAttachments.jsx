...
export default function TicketAttachments({ticket,attachments,members,user,config,enabled,busy,setBusy,request,accept,notice,onView,onEdit,onRemove,saveOffline}){
