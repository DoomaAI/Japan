...
export const FOOD=[
 ...
 {id:'gyudon',en:'Gyudon — beef on rice',ja:'牛丼',romaji:'gyūdon',say:'gyoo-don',hold:'gyoo',kind:'meal',note:'Fast, cheap and everywhere.'},
 ...
 {id:'butterbeer',en:'Butterbeer',ja:'バタービール',romaji:'batā bīru',say:'ba-tah bee-roo',hold:['tah','bee'],kind:'snack',note:'Hogsmeade at Universal, day five. Not alcoholic.'},
 {id:'corndog',en:'Cheese corn dog',ja:'チーズドッグ',romaji:'chīzu doggu',say:'chee-zoo dog-goo',hold:['chee','dog'],kind:'snack',note:'Street food in Harajuku and Osaka.'},
 ...
 {id:'kakigori',en:'Kakigori — shaved ice',ja:'かき氷',romaji:'kakigōri',say:'ka-kee-goh-ree',hold:'goh',kind:'sweet',note:'Far softer than a snow cone. Matcha and strawberry are everywhere.'},
 {id:'crepe',en:'Harajuku crepe',ja:'クレープ',romaji:'kurēpu',say:'koo-reh-poo',hold:'reh',kind:'sweet',note:'Takeshita Street, day thirteen. Choose from the plastic models outside.'},
 {id:'pancake',en:'Soufflé pancakes',ja:'パンケーキ',romaji:'pankēki',say:'pan-keh-kee',hold:'keh',kind:'sweet',note:'FLIPPER’S on our last Shibuya morning. They wobble.'},
 ...
 {id:'matcha',en:'Matcha',ja:'抹茶',romaji:'matcha',say:'mat-cha',hold:'mat',kind:'drink',note:'On the plan almost daily. Bitter, grassy and green.'},
 {id:'matchalatte',en:'Matcha latte',ja:'抹茶ラテ',romaji:'matcha rate',say:'mat-cha lah-teh',hold:'mat',kind:'drink',note:'The gentler way in for the boys.'},
 {id:'hojicha',en:'Hojicha — roasted green tea',ja:'ほうじ茶',romaji:'hōjicha',say:'hoh-jee-cha',hold:'hoh',kind:'drink',note:'Toasty, brown and barely bitter. Low in caffeine.'},
 ...
 {id:'melonsoda',en:'Melon soda with ice cream',ja:'クリームソーダ',romaji:'kurīmu sōda',say:'koo-ree-moo soh-da',hold:['ree','soh'],kind:'drink',note:'Bright green, in an old-fashioned café glass.'},
 {id:'cornpotage',en:'Hot corn soup from a machine',ja:'コーンポタージュ',romaji:'kōn potāju',say:'kohn po-tah-joo',hold:['kohn','tah'],kind:'drink',note:'From a vending machine, warm in the can. Strangely good.'},
...
export const SAY_TIP='Say each chunk evenly — Japanese does not stress one part the way English does. Where a chunk is marked, hold it for two beats instead of one: that length is what tells two words apart.';
...
export const ORDERING=[
 ...
 {id:'allergy',en:'Does this contain nuts, egg or dairy?',ja:'これにナッツ・卵・乳製品は入っていますか？',romaji:'kore ni nattsu, tamago, nyūseihin wa haitte imasu ka?',say:'ko-reh nee nat-tsoo, ta-ma-go, nyoo-say-heen wa ha-eet-teh ee-mass ka',hold:['nyoo','nat']},
 {id:'nopork',en:'Is there anything without pork?',ja:'豚肉が入っていないものはありますか？',romaji:'butaniku ga haitte inai mono wa arimasu ka?',say:'boo-ta-nee-koo ga ha-eet-teh ee-nigh mo-no wa a-ree-mass ka',hold:'eet'},
 {id:'highchair',en:'Do you have a high chair?',ja:'子供用の椅子はありますか？',romaji:'kodomo-yō no isu wa arimasu ka?',say:'ko-do-mo-yoh no ee-soo wa a-ree-mass ka',hold:'yoh'},
 ...
 {id:'meatinthis',en:'Is there meat in this?',ja:'これに肉は入っていますか？',romaji:'kore ni niku wa haitte imasu ka?',say:'ko-reh nee nee-koo wa ha-eet-teh ee-mass ka',hold:'eet'},
 {id:'vegetarian',en:'Do you have a vegetarian dish?',ja:'ベジタリアンの料理はありますか？',romaji:'bejitarian no ryōri wa arimasu ka?',say:'beh-jee-ta-ree-an no ryoh-ree wa a-ree-mass ka',hold:'ryoh'},
 {id:'cucumberroll',en:'A cucumber roll, please',ja:'かっぱ巻きをください',romaji:'kappamaki o kudasai',say:'kap-pa-ma-kee oh koo-da-sigh',hold:'kap'},
 ...
 {id:'delicious',en:'It was delicious — thank you',ja:'ごちそうさまでした',romaji:'gochisōsama deshita',say:'go-chee-soh-sa-ma desh-ta',hold:'soh'}
];
