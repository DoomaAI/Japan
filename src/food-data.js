...
export const FOOD=[
 {id:'tonkatsu',en:'Tonkatsu — crumbed pork cutlet',ja:'とんかつ',romaji:'tonkatsu',say:'ton-kat-soo',kind:'meal',note:'Maisen on day two is one of the famous ones. Comes with shredded cabbage and rice.'},
 {id:'katsucurry',en:'Katsu curry',ja:'カツカレー',romaji:'katsu karē',say:'kat-soo ka-reh',kind:'meal',note:'Mild, thick and brown — not a spicy curry. A reliable one for the boys.'},
 {id:'ramen',en:'Ramen',ja:'ラーメン',romaji:'rāmen',say:'rah-men',kind:'meal',note:'Ask for it without the spicy oil if you are unsure.'},
 ...
 {id:'udon',en:'Udon — thick wheat noodles',ja:'うどん',romaji:'udon',say:'oo-don',kind:'meal',note:'Soft and mild. Usually the gentlest noodle on a menu.'},
 ...
 {id:'tempura',en:'Tempura — light battered prawns and vegetables',ja:'天ぷら',romaji:'tenpura',say:'ten-poo-ra',kind:'meal',note:'Crisp, not greasy. Dip it in the sauce or the salt.'},
 {id:'oyakodon',en:'Oyakodon — chicken and egg on rice',ja:'親子丼',romaji:'oyakodon',say:'oh-ya-ko-don',kind:'meal',note:'Soft, savoury and easy. A very good child order.'},
 ...
 {id:'okonomiyaki',en:'Okonomiyaki — savoury pancake',ja:'お好み焼き',romaji:'okonomiyaki',say:'oh-ko-no-mee-ya-kee',kind:'meal',note:'An Osaka thing. Often cooked on the table.'},
 ...
 {id:'yakitori',en:'Yakitori — grilled chicken skewers',ja:'焼き鳥',romaji:'yakitori',say:'ya-kee-to-ree',kind:'side',note:'Ask for shio (salt) or tare (sweet sauce).'},
 ...
 {id:'gyoza',en:'Gyoza — pan-fried dumplings',ja:'餃子',romaji:'gyōza',say:'gyoh-za',kind:'side',note:'Crisp on the bottom, soft on top.'},
 ...
 {id:'onigiri',en:'Onigiri — rice ball',ja:'おにぎり',romaji:'onigiri',say:'oh-nee-gee-ree',kind:'snack',note:'Convenience-store ones have a clever wrapper that keeps the seaweed crisp.'},
