...
import {AlertCircle,Trash2,LockKeyholeOpen,CornerUpLeft} from 'lucide-react';
...
export default function RemoveStop({state,step,busy,mutate,notice,close,dayLabel}){
 ...
 return <div className="confirm-remove">
  ...
  {step.locked&&<><p className="callout"><LockKeyholeOpen size={18}/>This stop has a locked time, so it cannot be removed by accident. Unlock it first if it really is going.</p>
