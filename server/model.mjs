...
export function applyOperation(input,op,user){
 ...
 if(!parent && !['status','challengeStatus','challengeSkip','challengeNew','eyeSpy','parkRide','foodTried','foodRating','phraseSeen','shoppingAdd','shoppingStatus','acknowledge'].includes(op.type))throw new AppError('A parent can make this change.',403);
